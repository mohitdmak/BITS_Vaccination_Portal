    ...
    const extraDetailsPost = () => {
        fetch('https://vaccination.bits-dvm.org/api/student/extra', {
            ...
            body: JSON.stringify({
                ...
                "city": city,
                "state": region,
                "is_containment_zone": isContainment === "true",
                ...
                "staying_on_campus": stay === "true",
                "is_above_18": isAbove18 === "true"
            }),
            headers: {
                'Content-Type': 'application/json',
            }
            ...
            {name ?
                <>
                    ...
                    >
                            ...
                            <Heading fontSize="22px">Step 1: Update your documents</Heading>
                                <List spacing={3} mt="20px">
                                    <ListItem>
                                        ...
                                        Click on the select button to select a file from your computer.
                                    </ListItem>
                                    <ListItem>
                                        <ListIcon as={MdCheckCircle} color='green.500' />
                                        Once you have selected the correct file, please <b>press the Update button</b>.
                                    </ListItem>
                                    <ListItem>
                                        <ListIcon as={MdCheckCircle} color='green.500' />
                                        Once your PDFs are both updated the View button will be activated.
                                    </ListItem>
                                    <ListItem>
                                        <ListIcon as={MdCheckCircle} color='green.500' />
                                        To make sure everything is saved correctly, you may Re-login and see that all the fields have the values which you filled.
                                    </ListItem>
                        ...
                        <Flex marginTop="60px" ml="5px" width={["80vw", "80vw", "80vw", "1040px", "1040px"]} flexDir="column">
                            <Heading fontSize="22px">Step 2: Provide additional information</Heading>
                            <List spacing={3} mt="20px">
                                    <ListItem>
                                        <ListIcon as={MdCheckCircle} color='green.500' />
                                        Please fill the below form carefully.
                                    </ListItem>
                                    <ListItem>
                                        <ListIcon as={MdCheckCircle} color='green.500' />
                                        After filling the details, please make sure that you save the details by <b>pressing the Submit button</b>.
                                    </ListItem>
                                    {/* You can also use custom icons from react-icons */}
                                    {/* <ListItem>
                                        <ListIcon as={MdSettings} color='green.500' />
                        ...
                        >
                            ...
                            <Box width={"100%"} mt="50px" bg="rgba(0, 0, 0, 0.05)" p="10px" borderRadius="10px" >
                                ...
                                /> */}
                                    ...
                                    Is your current location a containment zone? *
                                    </Text>
                                <RadioGroup onChange={setIsContainment} value={isContainment}>
                            ...
                            <Box width={"100%"} mt="50px" bg="rgba(0, 0, 0, 0.05)" p="10px" borderRadius="10px" >
                                ...
                                <RadioGroup onChange={setIsAbove18} value={isAbove18}>
                                    <Stack direction='column'>
                                        <Radio value='true'>Yes</Radio>
                                        <Radio value='false'>No</Radio>
                                    </Stack>
                            ...
                            <Box width={"100%"} mt="50px" bg="rgba(0, 0, 0, 0.05)" p="10px" borderRadius="10px" >
                            <Text fontWeight="bold" mb="10px">
                                        For what duration will you be staying on campus? *
                                    </Text>
                                <RadioGroup onChange={setStay} value={stay}>
                                    <Stack direction='column'>
                                        <Radio value='true'>I will be staying on campus during the entire semester.</Radio>
                                        <Radio value='false'>I will be staying only during examination.</Radio>
                                    </Stack>
                                </RadioGroup>
                            </Box>
                            ...
                            <Button
                                onClick={() => {
                                    ...
                                    else if (!(/^20[1-2][0-9][A-Z0-9]{4}[0-2][0-9]{3}[P]$/.test(studentId))) {
