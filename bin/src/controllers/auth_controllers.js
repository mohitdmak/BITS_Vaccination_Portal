...
const set_session_data = async (user, req, res) => {
    try {
        ...
        const ADMINISTRATORS = [
            "f20200048@pilani.bits-pilani.ac.in",
            "f20201229@pilani.bits-pilani.ac.in",
            "f20190024@pilani.bits-pilani.ac.in",
            "f20190663@pilani.bits-pilani.ac.in",
        ...
        if (student.length) {
            ...
            if ((allow_access.indexOf(rollNo) > -1)) {
                ...
                console.log("\n    Email disallowed during other batch's slot . . .");
                res.redirect("/");
            }
        }
        else {
